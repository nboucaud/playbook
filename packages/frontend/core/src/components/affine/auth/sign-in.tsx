      ...
      <div className={style.authModalContent}>
        ...
        <div className={style.authMessage}>
          ...
          <Trans i18nKey="com.affine.auth.sign.message">
              ...
              you agree to Infogito&apos;s <a href="https://affine.pro/terms" target="_blank" rel="noreferrer">Terms of Conditions</a> and <a href="https://affine.pro/privacy" target="_blank" rel="noreferrer">Privacy Policy</a>.
          </Trans>
        </div>
      </div>
