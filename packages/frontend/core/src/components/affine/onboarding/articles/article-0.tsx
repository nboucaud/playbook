...
import { h1, h2, h3, p } from './blocks.css';
...
export const article0: Array<OnboardingBlockOption> = [
  ...
  },
  {
    ...
    children: (
      <>
        ...
        <h3 className={h3}>Spend time efficiently</h3>
      </>
    ),
    offset: { x: 200, y: 100 },
  },
...

  {
    ...
    children: (
      <>
        <h2 className={h2}>Choose good problems</h2>
        <p className={p}>
...

  {
    ...
    children: (
      <>
        <h2 className={h2}>Have a bunch of them</h2>
        <p className={p}>
  ...
  },
  {
    ...
    children: (
      <>
        <h2 className={h2}>Make a list</h2>
        <p className={p}>
...

  {
    ...
    children: (
      <>
        <h2 className={h2}>Integrate the list with your life</h2>
        <p className={p}>
